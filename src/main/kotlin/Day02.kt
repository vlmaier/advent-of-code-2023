...
fun main() {
    ...
    solveDay2Part1(input).let { println("Part 1: $it") }
    solveDay2Part2(input).let { println("Part 2: $it") }
}

fun solveDay2Part1(input: List<String>): Int {
    var sum = 0
    for (line in input) {
        val game = Game(line)
...
fun solveDay2Part2(input: List<String>): Int {
    var sum = 0
    for (line in input) {
        val game = Game(line)
        sum += game.getPower()
